import { R as ResolverContract, b as ResolverProps, c as Resolver } from '../../adapter.contract-EQE3rlgO.js';
 ...
 * @public
 */
type ServerlessCallback<TResponse> = (error: Error | null, success: TResponse | null) => void;
/**
 ...
 * @public
 */
declare class CallbackResolver<TEvent, TContext, TResponse> implements ResolverContract<TEvent, TContext, ServerlessCallback<any>, TResponse, void> {
    /**
     * {@inheritDoc}
     */
...
export { CallbackResolver, type ServerlessCallback };
