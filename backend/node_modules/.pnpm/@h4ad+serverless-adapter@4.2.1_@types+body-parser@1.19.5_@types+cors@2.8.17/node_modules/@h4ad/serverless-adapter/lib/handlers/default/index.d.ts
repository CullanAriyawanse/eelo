...
import { A as AdapterContract, R as ResolverContract, a as AdapterRequest, S as ServerlessResponse } from '../../adapter.contract-EQE3rlgO.js';
import { F as FrameworkContract } from '../../framework.contract-YnJ-fl1w.js';
import { B as BaseHandler } from '../../base-handler-fYEk59Xq.js';
 ...
 * @public
 */
declare class DefaultHandler<TApp, TEvent, TContext, TCallback, TResponse, TReturn> extends BaseHandler<TApp, TEvent, TContext, TCallback, TResponse, TReturn> {
    /**
     * {@inheritDoc}
     */
