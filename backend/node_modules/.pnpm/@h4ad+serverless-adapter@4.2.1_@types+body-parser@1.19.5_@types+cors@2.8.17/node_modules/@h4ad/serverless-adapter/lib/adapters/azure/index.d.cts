import { HttpRequest, Context, HttpResponseSimple, Cookie } from '@azure/functions';
 ...
 * @public
 */
declare class HttpTriggerV4Adapter implements AdapterContract<HttpRequest, Context, HttpResponseSimple> {
...
export { HttpTriggerV4Adapter, type HttpTriggerV4AdapterOptions };
